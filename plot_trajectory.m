...
hold on
plot(Eta1{2}(:,1), Eta1{2}(:,2), '-', 'Color', [0.4660 0.6740 0.1880], 'LineWidth', 1); 
hold on
plot(Eta1{3}(:,1), Eta1{3}(:,2), '-', 'Color', [0.4660 0.6740 0.1880], 'LineWidth', 1);
hold on;
plot(Eta1{4}(:,1), Eta1{4}(:,2), '--', 'Color', [0 0.4470 0.7410], 'LineWidth', 1);
hold on;
plot(Eta1{5}(:,1), Eta1{5}(:,2), '--', 'Color', [0.8500 0.3250 0.0980], 'LineWidth', 1);
hold on;
plot(Eta1{6}(:,1), Eta1{6}(:,2), '--', 'Color', [0.9290 0.6940 0.1250], 'LineWidth', 1);
hold on;
plot(Eta1{7}(:,1), Eta1{7}(:,2), '--', 'Color', [0.4940 0.1840 0.5560], 'LineWidth', 1);
hold on;
